...
const Navigatin = ({ links = [] }: NavigationProps) => {
    ...
    useEffect(() => {
        ...
        if (elem.current) 
        {
            const observer = new IntersectionObserver(
                ([e]) => setLogoIsVisible(e.intersectionRatio === 1),
                { threshold: [0, 1] }
            );
    ...
    return (
        <nav ref={elem} className={styles.navigationitems}>
            ...
            <div className={styles.btnBucket}>
                <div className={styles.btnWrapper}>
                    <BasketButton btnAction={() => {}}>
